...
//        for (int i = 0; i < 10; i++) {
            ...
            Response post = given().log().all().post(swapiURL);
            Response put = given().log().all().put(swapiURL);
            Response delete = given().log().all().delete(swapiURL);
            Response head = given().log().all().head(swapiURL);
